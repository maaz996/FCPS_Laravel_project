        ...
        <div class="card-bor">
          ...
          <div class="dbl-field">
            <div class="field" style="margin-right: 30px">
              ...
              <input type="text" name="student_name" placeholder="Student Name" value="{{ old('student_name') }}" required/>
            </div>
          ...
          <div class="dbl-field">
            ...
            <div class="field" style="margin-right: 30px">
              <span>D.O.B*</span>
              <input type="text" name="D_O_B" placeholder="yyyy-mm-dd" required/>
            </div>
            <div class="field">
              <span>B.Group*</span>
              <input type="text" name="B_Group" placeholder="B.Group" required/>
            </div>
          </div>
          ...
          <div class="dbl-field">
            <div class="field" style="margin-right: 30px">
              <span>Mob No*</span>
              <input type="text" name="mob_number" placeholder="Mob No" required/>
            </div>
            <div class="field" style="margin-right: 30px">
              <span>W. No*</span>
              <input type="text" name="w_number" placeholder="W. No" required/>
            </div>
            <div class="field">
              <span>F/G. Phone No*</span>
              <input type="text" name="fg_number" placeholder="F/G. Phone No" required/>
            </div>
          </div>
          ...
          <div class="dbl-field">
            ...
            >
              ...
              <input type="text" name="father_occupation" placeholder="Father/Guardian’s Occupation" required/>
            </div>
            <div
              class="field"
              style="margin-right: 30px; width: calc(45% - 10px)"
          ...
          <div class="dbl-field">
            ...
            >
              ...
              <input type="text" name="permanet_address" placeholder="Permanent Address" required/>
            </div>
            <div
              class="field"
              style="margin-right: 30px; width: calc(100% - 10px)"
          ...
          <div class="dbl-field">
            ...
            <div class="form-check">
              <label>
                <input type="radio" value="1" name="show_shift[]" />
                Morning
              </label>
              <label>
                <input type="radio" value="2" name="show_shift[]" />
                Evening
              </label>
            </div>
          </div>
          ...
          <div class="dbl-field">
            <div class="field" style="margin-right: 30px">
              ...
              <input type="text" name="ssc_institution_name" placeholder="Name of Institution" required/>
            </div>
            <div class="field" style="margin-right: 30px">
              <span>Roll No*</span>
              <input type="text" name="ssc_roll_no" placeholder="Roll No" required/>
            </div>
            <div class="field">
              <span>Passing Year*</span>
              <input type="text" name="ssc_passing_year" placeholder="Passing Year" required/>
            </div>

            <div class="field" style="margin-right: 30px">
              <span>Marks Obtained*</span>
              <input type="text" name="ssc_marks_obtained" placeholder="Marks Obtained" required/>
            </div>
            <div class="field" style="margin-right: 302px">
              <span>% / Div.*</span>
              <input type="text" name="ssc_div" placeholder="% / Div." required/>
            </div>
          </div>
          <!-- --------------------------------------------------------- -->
          ...
          <div class="dbl-field">
            <div class="field" style="margin-right: 30px">
              <span>Name of Institution*</span>
              <input type="text" name="institution_name" placeholder="Name of Institution" required/>
            </div>
            <div class="field" style="margin-right: 30px">
              <span>Roll No*</span>
            ...
            <div class="field">
              <span>Passing Year*</span>
              <input type="text" name="passing_year" placeholder="Passing Year" required/>
            </div>
            <div class="field" style="margin-right: 30px">
              <span>Marks Obtained*</span>
              <input type="text" name="marks_obtained" placeholder="Marks Obtained" required/>
            </div>
            <div class="field" style="margin-right: 302px">
              <span>% / Div.*</span>
